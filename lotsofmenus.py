...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                     description="a Japanese noodle soup dish. It consists of Chinese-style wheat "
                                "noodles served in a meat- or (occasionally) fish-based broth, "
                                "often flavored with soy sauce or miso, and uses toppings such "
                                "as sliced pork, dried seaweed, kamaboko, and green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
...
menuItem5 = MenuItem(user_id=1, name="Aloo Gobi Burrito",
                     description="Vegan goodness. Burrito filled with rice, garbanzo beans, curry "
                                "sauce, potatoes (aloo), fried cauliflower (gobi) and chutney. Nom Nom",
...
menuItem1 = MenuItem(user_id=1, name="Shellfish Tower",
                     description="Lobster, shrimp, sea snails, crawfish, stacked into a delicious "
                                "tower",
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and seasoned with a "
                                "spicy mix(chilli, tamarind among others) and slow cooked in a "
                                "cylindrical clay or metal oven which gets its heat from burning charcoal.",
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast",
                     description="Crispy Toast with Sesame Seeds slathered with buttery chantrelle "
                                "mushrooms",
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                    ...
                    "(guanciale)", price="$6.95", course="Dessert", restaurant=restaurant1)
